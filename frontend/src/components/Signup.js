  ...
  return (
    <div className='container'>
        ...
        <div className="modal-dialog">
            ...
            <input type="first name" className="form-control" id="exampleInputEmail1" aria-describedby="firstnameHelp" />
          
        </div>
        <div className="mb-3">
        <label htmlFor="exampleInputEmail1" className="form-label">Second Name</label>
        <input type="second name" className="form-control" id="exampleInputEmail1" aria-describedby="secondnameHelp" />
